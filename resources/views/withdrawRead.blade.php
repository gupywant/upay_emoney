            ...
            <div class="col-xl-12 order-xl-1">
	          <div class="card">
	            ...
	            <div class="card-body">
	            	...
	            	<form action="{{route('withdrawReadedPost', $card_id)}}" method="post" enctype="multipart/form-data">
	            	{{csrf_field()}}
	                <div class="pl-lg-4">
	                  <div class="row">
	                    <div class="col-lg-6">
	                      <div class="form-group">
	                        <label class="form-control-label" for="input-username">Total Balance</label>
	                        <input type="text" readonly="" value="Rp. {{number_format($total_balance)}}" name="total_balance" id="input-username" class="form-control" placeholder="Total Balance" required="">
	                      </div>
	                    </div>
	                  </div>
	                  <div class="row">
	            ...
	            <div class="card-footer">
	              <div class="row align-items-center">
	                ...
	                <div class="col-4 text-right">
	                  <input type="submit" class="btn btn-md btn-primary" value="Withdraw">
	                </div>
	              </div>
	            </div>
	              </form>
