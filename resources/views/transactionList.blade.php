        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Transaction Report</h6>
	              ...
	              <table class="table align-items-center table-flush" id="myTable">
	                <thead class="thead-light">
	                  <tr>
	                    ...
	                    <th scope="col" class="sort" width="20%" data-sort="status">Merchant Name</th>
	                    <th scope="col" class="sort" width="20%" data-sort="status">Note</th>
	                ...
	                @foreach($transaction as $key => $data)
	                  <tr>
	                    ...
	                    <td>
	                    	@php
	                    		$amount = Session::get('id') !== $data->id_user ? $data->amount + ($data->amount * 0.02) : $data->amount;
	                    	@endphp
	                      {{$amount}}
	                    </td>
	                    <td>
