        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Create Transaction</h6>
            ...
            <div class="col-xl-12 order-xl-1">
	          <div class="card">
	            ...
	            <div class="card-body">
	            	...
	            	<form action="{{route('transactionReadedPost', $card_id)}}" method="post" enctype="multipart/form-data">
	            	{{csrf_field()}}
	                <div class="pl-lg-4">
	                  <div class="row">
	                    <div class="col-lg-6">
	            ...
	            <div class="card-footer">
	              <div class="row align-items-center">
	                ...
	                <div class="col-4 text-right">
	                  <input type="submit" class="btn btn-md btn-primary" value="Create Transaction">
	                </div>
	              </div>
	            </div>
	              </form>
